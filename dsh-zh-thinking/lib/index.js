// dsh-zh-thinking host half — 中文思考开关
// - settings 命名空间 `zh-thinking` 持久化开关(enabled)
// - systemPrompt section:`zh-thinking` 按开关注入中文思考指令
// - HTTP API:GET /api/zh-thinking → { enabled } ; POST /api/zh-thinking { enabled } → 更新
import z from '@deepseek-ai/schemastery'

export const inject = ['systemPrompt', 'settings', 'webServer']
